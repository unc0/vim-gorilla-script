...
syn keyword gorillaSpecialMacro   mutable const static extends
...
syn keyword gorillaSpecialOp     as with from promise! to-promise! to-promise-array! promisefor every-promise! some-promise! from-promise! fulfilled! rejected! delay!
